 ...
 * |   Z  |   X  |   C  |   V  |   B  |  '   |  "   |   N  |   M  |   ,  |   .  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | RAISE| LOWER| Esc  | Ctrl | Alt  | GUI  | Enter| Space| Bksp |  TAB | Left |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
   KC_Q,              KC_W,  KC_E,    KC_R,    KC_T,    KC_LCBR, KC_RCBR,       KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,    \
   MT(KC_LCTL,KC_A),  KC_S,  KC_D,    KC_F,    KC_G,    S(KC_8), S(KC_9),       KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, \
   KC_Z,              KC_X,  KC_C,    KC_V,    KC_B,    S(KC_7), S(KC_2),       KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
   RAISE,             LOWER, FEATURE, KC_LCTL, KC_LALT, KC_LGUI, SFT_T(KC_ENT), KC_SPC, KC_BSPC, KC_TAB,  KC_LEFT, KC_RGHT  \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
 _______, _______, _______, _______, _______, _______, _______,       _______,    _______,    _______, _______, _______, \
 KC_EXLM, KC_QUOT, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS,       KC_EQL,     KC_MINS,    KC_TILD, KC_CIRC, KC_PIPE, \
 _______, _______, _______, _______, _______, _______, _______,       S(KC_NUHS), S(KC_NUBS), KC_GRV,  KC_AT,   _______, \
 _______, _______, _______, _______, _______, _______, SFT_T(KC_ENT), KC_SPC,     KC_BSPC,    KC_SCLN, KC_COLN, _______  \
),
