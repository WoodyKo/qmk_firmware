 ...
 * |      A    |    S  |    D   |    F    |     G    |     (      |     )    |   H  |   J  |   K  |   L  |   ;  |
 * |-----------+-------+--------+---------+----------+------------+----------+------+------+------+------+------|
 * |      Z    |    X  |    C   |    V    |     B    |   FEATURE  |    ESC   |   N  |   M  |   ,  |   .  |   /  |
 * |-----------+-------+--------+---------+----------+------------+----------+------+------+------+------+------|
 * | RAISE,Eisu| LOWER |  Kana  | Ctrl,TAB| SFT,Space|     GUI    | Alt,Enter| Bksp | Left | Down |  Up  |Right |
 * `------------------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  KC_Z,                 KC_X,                 KC_C,     KC_V,          KC_B,          FEATURE, S(KC_ESC),     KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, \
  LT(_RAISE, KC_LANG2), MO(_LOWER), KC_LANG1, CTL_T(KC_TAB), SFT_T(KC_SPC), KC_LGUI, ALT_T(KC_ENT), KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT  \
),
...
[_FEATURE] = LAYOUT_ortho_4x12( \
  KC_BRID, KC_BRIU, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, \
  KC_APP,  _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, \
...
* |      |      |      |      |      |      |      |ISO ~ |ISO | |   ;  |   :  |   ]  |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      |      |      | Ctrl | Shift| GUI  |Enter | Bksp |   <  |   >  |   ?  |   _  |
* `-----------------------------------------------------------------------------------'
*/
[_LOWER] = LAYOUT_ortho_4x12( \
 KC_EXLM, KC_DQUO, KC_HASH, KC_DLR,  KC_PERC, KC_AMPR, _______,       KC_EQL,     KC_MINS,    KC_CIRC, KC_TILD, KC_PIPE, \
 KC_QUES, KC_QUOT, _______, _______, _______, _______, _______,       _______,    _______,    _______, KC_AT,   KC_LBRC, \
 _______, _______, _______, _______, _______, _______, _______,       S(KC_NUHS), S(KC_NUBS), KC_SCLN, KC_COLN, KC_RBRC, \
 _______, _______, _______, KC_LCTL, KC_LSFT, KC_LGUI, SFT_T(KC_ENT), KC_BSPC,    KC_LABK,    KC_RABK, KC_QUES, KC_UNDS  \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, KC_LCTL, KC_LSFT, KC_LGUI, SFT_T(KC_ENT), KC_BSPC, KC_0, _______, KC_EQL, KC_SLSH  \
),
